...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = MOTOR_R_ENABLE_PWM_Pin|CHARGER_ENABLE_PWM_Pin|MOTOR_L_ENABLE_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM15)
  {
    ...
    PB15     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = BUTTON_LED_YELLOW_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM15;
    HAL_GPIO_Init(BUTTON_LED_YELLOW_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM17)
  {
    ...
    PB9     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = BUTTON_LED_ORANGE_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM17;
    HAL_GPIO_Init(BUTTON_LED_ORANGE_PWM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = JP1_TX_Pin|JP1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, JP1_TX_Pin|JP1_RX_Pin);
