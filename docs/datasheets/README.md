...
- `U3_U4_TI_LM158_LM258_LM358_dual_op_amp_alt.pdf`
  ...
  - Confidence: probable family match. ST direct datasheet download timed out, so TI LM158/LM258/LM358-family datasheet is kept as alternate pinout/behavior reference. User probing now indicates U3 is powered from `SWITCHED_SENSOR_5V`, likely pin 8 if the LM258 pinout matches.
